package com.ar.pay.wechatshare.widget;

/**
 * author：Administrator on 2017/2/23 10:51
 * company: xxxx
...
public class CustomTitleBar extends LinearLayout {
    ...
    public CustomTitleBar(Context context, AttributeSet attrs) {
        ...
        /**返回按钮相关*/
        left_button_imageId = typedArray.getResourceId(R.styleable.CustomTitleBar_left_button_image, R.mipmap.ico_back);
        ...
        left_button_textSize = typedArray.getColor(R.styleable.CustomTitleBar_left_button_textSize, 15);
        ...
        right_button_textSize = typedArray.getColor(R.styleable.CustomTitleBar_right_button_textSize, 15);
